...
can be interpreted using a universal kinship model, where humanity is viewed as a single extended family.
...
```text
All Indians and other nationalities people
            |
            +--> Universal Family
                     |
                     +--> Brothers
                     |      └── Kin / Allies / Companions
                     |
                     +--> Sisters
                            └── Kin / Companions / Nurturers
